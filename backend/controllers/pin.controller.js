...
export const deletePin = async (req, res) => {
  try {
    const { id } = req.params;
    const userId = req.userId; // Use req.userId based on your existing pattern

    // Find the pin and verify it exists
    ...
    // Optional: Delete related likes and saves to maintain data integrity
